...
func InitVariable() error {
	...
	//task_010
	var_.Image = "/ui/static/img/task_011.jpg"
	var_.Name = "Задания № 18.2.1, 18.4.1"
	var_.Describe = "Модуль 18. Wait group, основные шаблоны использования горутин<br/>"
	var_.Link = "/zTask011/"
	var_.PageHTML = "ui/html/zTask011.html"
	var_.Task = "-"
	ListTasksAll = append(ListTasksAll, var_) //14
	return nil
}
